...
print(f'R-18 函数位置: {r18_start} ~ {r18_end}')
print(f'R-19 函数位置: {r19_start} ~ {r19_end}')

# 替换 R-18 和 R-19 函数
new_content = content[:r18_start] + new_r18 + '\n' + content[r19_end:]

# 写回文件
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(new_content)

print('R-18 和 R-19 函数已替换')
