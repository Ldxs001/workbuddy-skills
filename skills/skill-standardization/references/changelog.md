...
### 修复
- 修复 trigger 去重；删除 docs 中 --fixed-rules 残留；修正约束章节引用
...
### 修复
- 移除 --fixed-rules 逃生口；修复 C-03/C-04/C-06/C-10/C-12/C-13c/C-14/C-17/C-18/C-19 审计输出，所有 C-xx 检查器现均输出 filepath:line + 锚点上下文
...
### 修复
- v2.86.2: 修复排除项机制、强制 HTML 报告、update 增加备份
...
### 修复
- R-11 _data_dir抑制+argparse sys.argv检测+html/markdown白名单+一致性审查过滤
...
### 修复
- 修复三处小问题：bare except 加警告、错误码表扩展至17条、FAQ新增常见错误章节
...
### 修复
- 修正 update/refactor 步骤编号 + 一致性审查钩子引导 LLM 对比流程
