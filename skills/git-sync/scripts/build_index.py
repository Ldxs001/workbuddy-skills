...
<body>
  ...
  <p class="subtitle">
    统一输出目录：<code>{html.escape(dist_real)}</code><br>
    点击文件名即可跳转 / 下载（需浏览器允许 file:// 协议）
  </p>
...
{rows}
  ...
  <p class="footer">
    由 git-sync v1.5.0 自动生成 · 最后更新：{datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
  </p>
</body>
</html>
"""
