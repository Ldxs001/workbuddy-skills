"""
rag-assistant 工具函数模块（独立副本，基于 local-rag-builder v1.5.0）
数据目录指向 rag-assistant/data/，与原始技能完全隔离
"""
...
_config_dir_abs = os.path.join(DATA_ROOT, "config")
_output_dir_abs = os.path.join(DATA_ROOT, "output")
_logs_dir_abs  = os.path.join(DATA_ROOT, "logs")
_cache_dir_abs = os.path.join(DATA_ROOT, "cache")

for d in [DATA_ROOT, _kb_dir_abs, _models_dir_abs, _prompts_dir_abs, _config_dir_abs, _output_dir_abs, _logs_dir_abs, _cache_dir_abs]:
